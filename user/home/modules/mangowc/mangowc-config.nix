...
in
{
  home.file.".config/mango/config.conf" = {
    ...
    bordercolor=0x${opt-config.colors.unfocus-border}ff
    focuscolor=0x${opt-config.colors.focus-border}ff
    maximizescreencolor=0x89aa61ff
    urgentcolor=0x${opt-config.colors.red}ff
    ...
    # App
    bind=SUPER,Return,spawn,${apps.terminal}
    bind=SUPER,d,spawn,${apps.dmenu} -show drun
    bind=SUPER,r,spawn,${apps.dmenu} -show run
    bind=SUPER+SHIFT,f,spawn,${apps.web-browser}
    bind=SUPER+SHIFT,l,spawn,my-swaylock idle
    bind=SUPER,c,spawn,wlroot-clipboard
    bind=SUPER+SHIFT,p,spawn,rofi-power-menu
    bind=NONE,XF86AudioRaiseVolume,spawn,my-volume up
    bind=NONE,XF86AudioLowerVolume,spawn,my-volume down
    bind=NONE,XF86AudioMute,spawn,my-volume mute
    bind=NONE,XF86MonBrightnessUp,spawn,${apps.brightnessctl} set 10%+
    bind=NONE,XF86MonBrightnessDown,spawn,${apps.brightnessctl} set 10%-
    bind=NONE,XF86AudioPlay,spawn,${apps.playerctl} play-pause
    bind=NONE,XF86AudioNext,spawn,${apps.playerctl} next
    ...
    # switch layout
    bind=SUPER,e,setlayout,tile
    bind=SUPER,m,setlayout,monocle
    bind=SUPER,s,setlayout,scroller

    # tag switch
    bind=CTRL+SUPER,k,viewtoleft,0
    # bind=CTRL,Left,viewtoleft_have_client,0
    bind=CTRL+SUPER,j,viewtoright,0
