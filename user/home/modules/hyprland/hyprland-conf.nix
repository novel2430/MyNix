...
in
{
  home.file.".config/hypr/hyprland.conf" = {
    ...
    $menu = ${apps.dmenu} -show drun
    $runmenu = ${apps.dmenu} -show run
    $browser = ${apps.web-browser}
    ...
    $brightnessUp = ${apps.brightnessctl} --class=backlight set +10%
    $brightnessDown = ${apps.brightnessctl} --class=backlight set 10%-
    $screenshot = grim-slurp-screenshot full
    $screenshotSelect = grim-slurp-screenshot
    $clashSwitcher = clash-switcher
    $playerctl = ${apps.playerctl}
    ...
    exec-once = my-hyprland-autostart &
    ...
    general {
        ...
        col.active_border = rgba(${opt-config.colors.focus-border}ff)
        col.inactive_border = rgba(${opt-config.colors.unfocus-border}ff)
    ...
    windowrule = noblur, class:wps
    windowrule = noblur, class:wpp
